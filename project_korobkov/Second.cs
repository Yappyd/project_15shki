...
namespace project_korobkov
{
    public partial class Second : Form
    {
        ...
        int x, y, number, name, checkI1, checkI2, checkI3, checkI4, winCheckI, schet, tik, checkX, checkY;
        ...
        private void Pic_Click(object sender, EventArgs e)
        {
            ...
            if (!checkB)
            {
                ...
                winTag1 = pic.Tag.ToString().Substring(2, 2);
                checkS = pic.Name;
            }
            else
            {
                ...
                winTag2 = pic.Tag.ToString().Substring(2, 2);
                checkX = Math.Abs(checkI1 - checkI3);
                checkY = Math.Abs(checkI2 - checkI4);
                if (checkX <= 1 && checkY <= 1 && (checkX != checkY))
                {
                    checkO2 = pic.Image;
                    pic.Tag = checkI3 + "" + checkI4 + "" + winTag1;
                    (panel1.Controls[checkS] as PictureBox).Tag = checkI1 + "" + checkI2 + "" + winTag2;
            ...
            {
                if (p.Tag.ToString().Substring(2, 2) == winArray[schet])
                {
                    winCheckI++;
                }
                schet++;
